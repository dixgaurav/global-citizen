...
export class GovOrgComponent implements OnInit {
  ...
  private currentId;
	private errorMessage;
          ...
          defaultMessage = new FormControl("", Validators.required);
  ...
  constructor(private serviceGovOrg:GovOrgService, fb: FormBuilder) {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: "org.global.citizens.net.GovOrg",
          ...
          "defaultMessage":this.defaultMessage.value,
    ...
    .then((result) => {
      ...
      let formObject = {
        ...
        if(result.defaultMessage){
            ...
            formObject.defaultMessage = result.defaultMessage;
          
        }else{
          formObject.defaultMessage = null;
        }
